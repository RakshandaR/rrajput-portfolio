...
When compared to other graphs, reading a Pie chart might be a little challenging if more data exists as the portion on the chart will reduce. Here it helps with visulalization as larger the portion of the Pie chart a country occupies, the more debt it has incurred. It is not necessary to look at the numbers, but the clour will be enough to point out the major differences.
It might be difficult though when the data figures would be very close to each other.
